...
<?php echo form_open('profile/update', array('class'=>'mainForm')); ?>
	<fieldset>
		<div class="widget first">
			...
			<?php echo form_field('select', array('label'=>'Sex', 'name'=>'sex','value'=>set_value("sex", $profile->sex), 'options'=>array("Male"=>"Male", "Female"=>"Female"), 'req'=>true)); ?>
			<?php echo form_field('select', array('label'=>'Course', 'name'=>'roll1','value'=>set_value("roll1", $profile->roll1), 'options'=> $courses, 'req'=>true)); ?>
			<?php echo form_field('text', array('label'=>'Roll', 'name'=>'roll2','value'=>set_value("roll2", $profile->roll2),'placeholder'=>'Eg. 10212', 'req'=>true)); ?>
			<?php echo form_field('select', array('label'=>'Batch', 'name'=>'roll3','value'=>set_value("roll3", $profile->roll3), 'options'=> $batches, 'req'=>true)); ?>
			<?php echo form_field('select', array('label'=>'Branch', 'name'=>'branch','value'=>set_value("branch", $profile->branch), 'options'=> $branches, 'req'=>true)); ?>
